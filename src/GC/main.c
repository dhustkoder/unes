...
const uint32_t gc_nes_colors[0x40] = {
	COLOR_GRAY, COLOR_BLUE, COLOR_BLUE, COLOR_PURPLE, COLOR_FUCHSIA, COLOR_RED,
	COLOR_RED, COLOR_RED, COLOR_MAROON, COLOR_GREEN, COLOR_GREEN, COLOR_GREEN,
	COLOR_BLUE, COLOR_BLACK, COLOR_BLACK, COLOR_BLACK,

	COLOR_SILVER, COLOR_BLUE, COLOR_BLUE, COLOR_PURPLE, COLOR_FUCHSIA, COLOR_RED,
	COLOR_RED, COLOR_RED, COLOR_GRAY, COLOR_GREEN, COLOR_GREEN, COLOR_GREEN,
	COLOR_BLUE, COLOR_BLACK, COLOR_BLACK, COLOR_BLACK,

	COLOR_WHITE, COLOR_SKYBLUE, COLOR_PURPLE, COLOR_PURPLE, COLOR_FUCHSIA, COLOR_RED,
	COLOR_RED, COLOR_RED, COLOR_YELLOW, COLOR_LIME, COLOR_LIME, COLOR_GREEN,
	COLOR_BLUE, COLOR_GRAY, COLOR_BLACK, COLOR_BLACK,

	COLOR_WHITE, COLOR_AQUA, COLOR_SKYBLUE, COLOR_PURPLE, COLOR_RED, COLOR_RED,
	COLOR_RED, COLOR_RED, COLOR_TEAL, COLOR_GREEN, COLOR_GREEN, COLOR_GREEN,
	COLOR_SKYBLUE, COLOR_WHITE, COLOR_BLACK, COLOR_BLACK
};
